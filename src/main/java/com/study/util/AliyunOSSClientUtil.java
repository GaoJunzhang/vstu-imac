...
import com.study.config.OSSClientConstants;
...
public class AliyunOSSClientUtil {
    ...
    //阿里云API的内或外网域名
    @Value("${aliyun.oos.END_POINT}")
    private static String ENDPOINT;
    //阿里云API的密钥Access Key ID
    @Value("aliyun.oos.ACCESS_KEY_ID")
    private static String ACCESS_KEY_ID;
    //阿里云API的密钥Access Key Secret
    @Value("aliyun.oos.ACCESS_KEY_SECRET")
    private static String ACCESS_KEY_SECRET;
    //阿里云API的bucket名称
    @Value("aliyun.oos.BUCKET_NAME")
    ...
    public static OSSClient getOSSClient(){
        ...
        ACCESS_KEY_ID="3uwjG50n0ynrdeW5";
        ACCESS_KEY_SECRET="4NczQoSubGqmubAuxuDahEF4Uo05HW";
